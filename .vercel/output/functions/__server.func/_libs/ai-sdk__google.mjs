import { w as withoutTrailingSlash, K as generateId, M as parseProviderOptions, b as combineHeaders, r as resolve, p as postJsonToApi, P as convertToBase64, L as createProviderToolFactory, j as createProviderToolFactoryWithOutputSchema, a as createJsonResponseHandler, i as createEventSourceResponseHandler, d as withUserAgentSuffix, O as loadApiKey, Q as delay, f as getFromApi, R as isSameOrigin, k as lazySchema, m as secureJsonParse, c as createJsonErrorResponseHandler, h as convertUint8ArrayToBase64, o as isAbortError, z as zodSchema, C as getRuntimeEnvironmentUserAgent } from "./ai-sdk__provider-utils.mjs";
import { d as TooManyEmbeddingValuesForCallError, a as AISDKError, U as UnsupportedFunctionalityError } from "./ai-sdk__provider.mjs";
import { o as object, n as number, b as string, c as array, f as boolean, e as union, u as unknown, l as literal, r as record, _ as _enum } from "./zod.mjs";
var VERSION = "3.0.111";
...
var contentBlockSchema = () => {
  ...
  const imageContent = object({
    ...
    data: string().nullish(),
    mime_type: string().nullish(),
    resolution: _enum(["low", "medium", "high", "ultra_high"]).nullish(),
    uri: string().nullish()
  }).loose();
...
var googleInteractionsLanguageModelOptions = lazySchema(
  () => zodSchema(
    object({
      ...
      thinkingLevel: _enum(["minimal", "low", "medium", "high"]).nullish(),
      thinkingSummaries: _enum(["auto", "none"]).nullish(),
      /**
      ...
      responseFormat: array(
        union([
          ...
          object({
            ...
            imageSize: _enum(["1K", "2K", "4K", "512"]).nullish()
          }).loose(),
          object({
            type: literal("audio"),
            mimeType: string().nullish()
      ...
      mediaResolution: _enum(["low", "medium", "high", "ultra_high"]).nullish(),
      responseModalities: array(_enum(["text", "image", "audio", "video", "document"])).nullish(),
      serviceTier: _enum(["flex", "standard", "priority"]).nullish(),
      /**

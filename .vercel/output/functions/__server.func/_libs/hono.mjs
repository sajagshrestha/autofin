...
var Hono$1 = class _Hono {
  ...
  */
  ...
  #addRoute(method, path, handler, baseRoutePath) {
    ...
    const r = {
      basePath: baseRoutePath !== void 0 ? mergePath$1(this._basePath, baseRoutePath) : this._basePath,
      path,
      method,
      handler
    };
...
var parse = (cookie, name) => {
  ...
  for (const pairStr of pairs) {
    ...
    if (!relaxedCookieNameRegEx.test(cookieName) || cookieName in parsedCookie) {
      continue;
    }

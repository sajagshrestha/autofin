...
const HandCoins = createLucideIcon("hand-coins", __iconNode$w);
const __iconNode$v = [
...
const MessageSquarePlus = createLucideIcon("message-square-plus", __iconNode$n);
const __iconNode$m = [
...
const OctagonX = createLucideIcon("octagon-x", __iconNode$k);
const __iconNode$j = [
  [
    "path",
    {
...
const PiggyBank = createLucideIcon("piggy-bank", __iconNode$i);
const __iconNode$h = [

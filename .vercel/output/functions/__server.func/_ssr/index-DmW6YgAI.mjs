...
import { l as Route$2, g as getDateRangeForPeriod, D as DateFilter, B as Button, S as Select, h as SelectTrigger, i as SelectValue, j as SelectContent, k as SelectItem, c as cn, f as buttonVariants } from "./router-CvFqzVfm.mjs";
...
import { u as useUpdateTransaction, a as useDeleteTransaction, b as useCreateTransaction, c as useCreateTransactionFromSms, E as EditTransactionForm, d as createFromSmsSchema, e as createTransactionSchema, m as mapCreateFormToCreateBody } from "./mutations-Bg1SDKJb.mjs";
...
import { D as DataTable, S as Search, N as NoData } from "./data-table-DLjzLZu9.mjs";
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuItem, d as DropdownMenuSeparator } from "./dropdown-menu-zEMaxGnk.mjs";
...
import { S as Skeleton } from "./skeleton-DQnnemnh.mjs";
...
function TransactionsPage() {
  ...
  const renderTransactionActions = (transaction, align = "end") => /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", className: "h-9 w-9 p-0 md:h-8 md:w-8", children: [
  ...
  const columns = [{
    ...
    cell: ({
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-right font-medium ${isDebit ? "text-red-600 dark:text-red-400" : "text-green-600 dark:text-green-400"}`, children: formatted });
    }
  }, {
    id: "transactionDate",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto space-y-8 min-w-0 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DataTable, { columns, data: filteredTransactions, isLoading, columnPinning: {
        state: {
          left: ["amount"],
          right: ["actions"]
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 md:hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3 p-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "col-span-2", onClick: () => setCreateOptionsOpen(true), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "mr-2 h-4 w-4" }),
              "Create transaction"
            ] })
          ] })
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "cursor-pointer", onClick: () => navigate({
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm font-semibold ${transaction.type === "debit" ? "text-red-600 dark:text-red-400" : "text-green-600 dark:text-green-400"}`, children: formattedAmount }),

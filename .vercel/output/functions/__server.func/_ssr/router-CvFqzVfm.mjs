...
import { createServerClient, createBrowserClient } from "./index-CH6UTATS.mjs";
...
import { g as getSessionUserFromCookieHeader, e as ensureAppUser, a as gmailOAuthTokens, t as transactions, c as categories, u as users, b as userPreferences, l as loans, d as db } from "./session-B9_AFGgo.mjs";
...
const appStyles = "/assets/__root-BqDH8wIR.css";
...
const $$splitComponentImporter$e = () => import("./index-CHZ6AaP9.mjs");
...
const $$splitComponentImporter$d = () => import("../_authenticated-B6wRojil.mjs");
...
const $$splitComponentImporter$c = () => import("./login-BO501zT4.mjs");
...
const $$splitComponentImporter$b = () => import("./privacy-KRhSWY0U.mjs");
const Route$c = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./signup-BBIYgJVD.mjs");
const Route$b = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./terms-BZq1VTqL.mjs");
...
const $$splitComponentImporter$8 = () => import("./dashboard-CiQM_mqJ.mjs");
...
const $$splitComponentImporter$7 = () => import("./settings-pZCbR_PL.mjs");
...
class TransactionRepository extends BaseRepository {
  ...
  async getSummaryForUser(userId, startDate, endDate) {
    ...
    const result = await this.db.select({
      totalDebit: sql`COALESCE(SUM(CASE WHEN ${transactions.type} = 'debit' AND ${transactions.loanId} IS NULL THEN ${transactions.amount} ELSE 0 END), 0)`,
      totalCredit: sql`COALESCE(SUM(CASE WHEN ${transactions.type} = 'credit' AND ${transactions.loanId} IS NULL THEN ${transactions.amount} ELSE 0 END), 0)`,
      loanOutflow: sql`COALESCE(SUM(CASE WHEN ${transactions.type} = 'debit' AND ${transactions.loanId} IS NOT NULL THEN ${transactions.amount} ELSE 0 END), 0)`,
      loanInflow: sql`COALESCE(SUM(CASE WHEN ${transactions.type} = 'credit' AND ${transactions.loanId} IS NOT NULL THEN ${transactions.amount} ELSE 0 END), 0)`,
      transactionCount: sql`COUNT(*)::int`
  ...
  return [
    {
      ...
      description: "Totals for a period: expenses and income EXCLUDING loan transfers (loanOutflow/loanInflow reported separately), plus net and transaction count. Omit dates for all-time.",
      inputSchema: object({
...
const $$splitComponentImporter$6 = () => import("./auth.callback-CfZJiLXN.mjs");
const Route$6 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./index-CCCG11-n.mjs");
const Route$5 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("../_categoryId-Cxsyr4ET.mjs");
const Route$4 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./index-DPVbF-A6.mjs");
const Route$3 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-DmW6YgAI.mjs");
...
const $$splitComponentImporter$1 = () => import("../_transactionId-B13D7B20.mjs");
const Route$1 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./import-9iYXrIWS.mjs");

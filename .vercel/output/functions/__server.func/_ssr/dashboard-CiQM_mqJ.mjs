...
import { C as Card, b as CardHeader, a as CardContent, c as CardTitle } from "./card-jswmrxmG.mjs";
...
import { b as Route$9, g as getDateRangeForPeriod, D as DateFilter } from "./router-CvFqzVfm.mjs";
...
import { t as ArrowDownRight, u as ArrowUpRight, P as PiggyBank, f as CreditCard, W as Wallet, A as ArrowRight, i as TrendingUp } from "../_libs/lucide-react.mjs";
...
function AnalyticsDashboard() {
  ...
  const {
    ...
    for (const t of transactions) {
      if (t.loanId) {
        ...
        regularTransactions2.push(t);
      }
    }
    return {
      regularTransactions: regularTransactions2,
      loanFlows: {
        lent,
        received,
  ...
  const spendingData = reactExports.useMemo(() => {
    ...
    if (hasRange && rangeStart && rangeEnd) {
      ...
      if (!regularTransactions.length) return [];
      const dates = regularTransactions.map((t) => t.transactionDate ? new Date(t.transactionDate) : null).filter((d) => d !== null);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "hover:shadow-md transition-shadow", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Excludes loan transfers" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "hover:shadow-md transition-shadow", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between pb-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "hover:shadow-md transition-shadow", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: loanFlows.count > 0 ? `+ ${loanFlows.count} loan transfer${loanFlows.count !== 1 ? "s" : ""} tracked separately` : "Total tracked" })
          ] })
        ] })
      ] }),
      loanFlows.count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-primary/20 bg-primary/[0.03]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "flex flex-wrap items-center gap-x-6 gap-y-2 px-4 py-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-3.5 w-3.5 text-red-500" }),
          "Lent ",
          formatCurrency(loanFlows.lent)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownRight, { className: "h-3.5 w-3.5 text-green-600" }),
          "Received ",
          formatCurrency(loanFlows.received)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/loans", className: "ml-auto inline-flex items-center gap-1 text-xs font-medium text-primary hover:underline", children: [
          "View loans ",

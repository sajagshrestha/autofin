...
import { B as BackButton } from "./BackButton-Ck9k3jV0.mjs";
import { B as Badge } from "./badge-uZ57TULk.mjs";
import { B as Button, S as Select, h as SelectTrigger, i as SelectValue, j as SelectContent, k as SelectItem } from "./router-CvFqzVfm.mjs";
...
function ImportStatementPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto space-y-6", children: [
    ...
    !extraction ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: `flex flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed p-8 text-center transition-colors sm:p-12 ${dragActive ? "border-primary bg-primary/5" : "border-muted-foreground/25 hover:border-primary/50 hover:bg-muted/40 cursor-pointer"}`, onDragOver: (e) => {
        e.preventDefault();
        setDragActive(true);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "px-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 px-4 pb-2 md:hidden", children: rows.map((row) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-xl border p-3 space-y-3 ${row.include ? "" : "opacity-45"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-sm font-medium", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", "aria-label": `Include ${row.merchant || "transaction"}`, checked: row.include, onChange: (e) => updateRow(row.id, {
                  include: e.target.checked
                }) }),
                row.merchant || "Transaction"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                row.confidence !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: lowConfidence ? "outline" : "secondary", title: "AI confidence", children: [
                  Math.round(row.confidence * 100),
                  "%"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "h-8 w-8 text-muted-foreground hover:text-red-600", onClick: () => removeRow(row.id), "aria-label": "Remove row", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }) })
              ] })
            ] }),
            row.duplicateOf && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "border-amber-500/50 bg-amber-500/10 text-[10px] text-amber-600 dark:text-amber-400", title: `Possible duplicate of an existing transaction (${row.duplicateOf.merchant ?? "unknown"}, ${row.duplicateOf.amount} NPR)`, children: "Duplicate?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Date & time" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "datetime-local", value: row.date, onChange: (e) => updateRow(row.id, {
                  date: e.target.value
                }), className: "h-8 w-full" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Amount" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", min: "0", step: "0.01", "aria-invalid": invalid, value: row.amount, onChange: (e) => updateRow(row.id, {
                  amount: e.target.value
                }), className: `h-8 w-full text-right ${row.type === "debit" ? "text-red-600 dark:text-red-400" : "text-green-600 dark:text-green-400"}` })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Type" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: row.type, onValueChange: (value) => updateRow(row.id, {
                  type: value
                }), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 w-full capitalize", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: row.categoryId || "none", onValueChange: (value) => updateRow(row.id, {
                  categoryId: value === "none" ? "" : value
                }), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Category" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Merchant" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: row.merchant, placeholder: "Merchant", onChange: (e) => updateRow(row.id, {
                merchant: e.target.value
              }), className: "h-8 w-full" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Remarks" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { value: row.remarks, placeholder: "—", rows: 1, onChange: (e) => updateRow(row.id, {
                remarks: e.target.value
              }), className: "min-h-8 w-full resize-y text-sm" })
            ] })
          ] }, row.id);
        }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block overflow-x-auto pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full min-w-[980px] text-sm", children: [
